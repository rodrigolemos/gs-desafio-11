...
Nesse desafio será criado um app mobile chamado GoRestaurant para pedidos de comida.
...
Todos os direitos reservados à **[Rocketseat](https://github.com/Rocketseat/bootcamp-gostack-desafios/tree/master/desafio-react-native-delivery).**
